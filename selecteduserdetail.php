...
if(isset($_POST['submit']))
{
    ...
    if (($amount)<0)
   {
    ...
    else if($amount > $sql1['balance']) 
    {
        ...
        $sender = $sql1['id'];
        $receiver = $sql2['id'];
        $sql = "INSERT INTO transaction(`sender_id`, `receiver_id`, `amount`) VALUES ('$sender','$receiver','$amount')";
        $query=mysqli_query($conn,$sql);
        if($query){
...
<body style="background-color : #949fb5;">
    <!-- Navigation bar-->
	...
	<div class="container">
        ...
        <br>
            ...
            <button class="btn mt-3 bg-primary" name="submit" type="submit" id="myBtn" >Transfer Money</button>
            </div>
        </form>
    </div>
