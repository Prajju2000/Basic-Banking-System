    ...
    <div class="row">
        <div class="col">
            <div class="table-responsive-sm">
              <table class="table table-hover table-sm table-dark" style="border-color:white;">
                  ...
                  ?>
                    <tr class="text-center" style="color : white;">
                        ...
                        <td class="py-2" style="padding-left:70px;"><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #a566a5BD;">Transfer money</button></a></td> 
                    </tr>
                    <?php
                        }
                    ?>
